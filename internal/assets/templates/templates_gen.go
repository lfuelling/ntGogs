...
func baseHeadTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "base/head.tmpl", size: 13946, mode: os.FileMode(420), modTime: time.Unix(1601055478, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
