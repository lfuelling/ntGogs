...
func baseFooterTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "base/footer.tmpl", size: 2819, mode: os.FileMode(420), modTime: time.Unix(1595872670, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func repoView_listTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "repo/view_list.tmpl", size: 2249, mode: os.FileMode(420), modTime: time.Unix(1595872670, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
